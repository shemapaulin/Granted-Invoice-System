...
<div id="File" className="w-full h-full  bg-gray-900 dark:bg-gray-900" >
  ...
  <div key={index} className="grid grid-cols-3 sm:grid-cols-5 gap-2">
   ...
   <footer className="p-6 dark:bg-[#0D6064] bg-[#0D6064] dark:text-white text-center">
<h1 className='font-medium text-white text-2xl'>Graphics design - Printing services - Branding - General supply</h1>
    ...
    trigger={()=>{
      ...
      return <a className="py-2 px-3 inline-flex items-left gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#0D6064] text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
